        ...
        <div className='relative z-0'>
            <div className='flex justify-between mb-32 h-[400px]'>
                ...
                <div className='relative w-[50%] left-[8%]'>
                    <div className={`${slide === 1 ? 'bg-primary' : slide===2 ? 'bg-pink-500': 'bg-orange-500' } rounded-full w-[472px] h-[472px] absolute top-10 left-[2%] animate-bounce`}>
                    </div>
                    <img src={data.img.src} alt='anh' className='h-[100vh] absolute top-[-50%] right-0 left-0' />
                </div>
            </div>
